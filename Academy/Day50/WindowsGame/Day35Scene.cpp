...
void Day35Scene::Init()
{
	...
	//Resource->CreateSprite(L"S_Image_Pressed", texture, 0, 98 * 2, 363, 98);
	//Resource->CreateSprite(L"S_Image_Disabled", texture, 0, 98 * 3, 363, 98);

	//{
	//	Button* button = new Button();
	//	button->Init();
	//	button->AddOnClickDelegate(this, &Day35Scene::AddCount);
	...
	GameResultPanel* panel = new GameResultPanel();
	panel->Init();
	this->AddUI(panel);
