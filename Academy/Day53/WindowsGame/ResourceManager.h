...
public:
	...
	DXSprite* CreateDXSprite(const wstring& key, const wstring& path);
	DXSprite* GetDXSprite(const wstring& key);


	DXFlipbook* CreateDXFlipbook(const wstring& key, DXFlipbookInfo info);
	DXFlipbook* GetDXFlipbook(const wstring& key);
